...
describe("retry policy tests", function () {
    ...
    const connectionPolicy = new __1.AzureDocuments.ConnectionPolicy();
    ...
    xit("throttle retry policy test default retryAfter", function () {
    ...
    xit("throttle retry policy test fixed retryAfter", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    xit("throttle retry policy test max wait time", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    xit("default retry policy validate create failure", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // const client = new CosmosClient(endpoint, { masterKey }, connectionPolicy);
            // const { result: db } = await client.createDatabase({ id: "sample database" });
            // const { result: collection } = await client.createCollection(db._self, collectionDefinition);
    ...
    xit("default retry policy validate read success", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // const client = new CosmosClient(endpoint, { masterKey }, connectionPolicy);
            // const { result: db } = await client.createDatabase({ id: "sample database" });
            // const { result: collection } = await client.createCollection(db._self, collectionDefinition);
