...
class ChangeFeedResponse {
     ...
     */
    get requestCharge() {
        const rus = this.headers[common_1.Constants.HttpHeaders.RequestCharge];
     ...
     */
    get activityId() {
        return this.headers[common_1.Constants.HttpHeaders.ActivityId];
    }
    /**
     ...
     */
    get sessionToken() {
        return this.headers[common_1.Constants.HttpHeaders.SessionToken];
    }
    /**
     ...
     */
    get etag() {
        return this.headers[common_1.Constants.HttpHeaders.ETag];
    }
}
